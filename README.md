<p align="center"><img src=".github/assets/zentropy-banner.png" alt="studio-engine: A native simulation and render engine: generate, critique, refine, and keep the scene." width="100%"></p>
