...
(`recipe`). The engine samples the same tree to compute the features its criteria judge, so the
chamber renders the exact math the engine witnessed. Stdlib only.
"""
